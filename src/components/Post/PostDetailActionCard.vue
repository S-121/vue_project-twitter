...
<div class="tweetAction">
  ...
  <div>
    ...
    <span class="subheading mr-2 text-h6 grey--text text--darken-2 font-weight-medium" >{{source.Stat.Cot }}</span>
  </div>
  <!--END 评论数-->
    ...
    >
      <template v-slot:activator="{ on, attrs }">
        <div>
          ...
          <span class="subheading mr-2 text-h6 grey--text text--darken-2 font-weight-medium" >
  ...
  <div @click.stop="source.StatU.ULikeU !== 1 ? postLiTweet(source,$event) : postDisLiTweet(source,$event)">
    <v-btn
        ...
        light
    >
      <v-icon :color="source.StatU.ULikeU !== 1 ? 'grey darken-2' : 'pink'">
  ...
  <div style="justify-content: flex-end; max-width: 20px">
    ...
    <v-icon >ri-bar-chart-line</v-icon>
    <span class="subheading ml-1 mr-2 text-h6 grey--text text--darken-2 font-weight-medium" >
      <label class="">
